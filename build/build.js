...
require.register("components~underscore@1.5.2", function (exports, module) {
//     Underscore.js 1.5.2
...
(function(factory) {
    ...
    //     factory(require('components-jquery'));
    } else {
        factory(jQuery);
    }
...
require.register("gtsnaker~message@master", function (exports, module) {
if(!window.dhtmlx)
	window.dhtmlx = {};
...
require.register("components~jquery@master", function (exports, module) {
/*!
...
(function($) {
	...
	var defaults = {
		...
		events:             [],
		templates:          {
			'day': require("gtsnaker~bootstrap-calendar@master/tmpls/day.html"),
			'events-list': require("gtsnaker~bootstrap-calendar@master/tmpls/events-list.html"),
			'modal': require("gtsnaker~bootstrap-calendar@master/tmpls/modal.html"),
			'month-day': require("gtsnaker~bootstrap-calendar@master/tmpls/month-day.html"),
			'month': require("gtsnaker~bootstrap-calendar@master/tmpls/month.html"),
			'week-days': require("gtsnaker~bootstrap-calendar@master/tmpls/week-days.html"),
			'week': require("gtsnaker~bootstrap-calendar@master/tmpls/week.html"),
			'year-month': require("gtsnaker~bootstrap-calendar@master/tmpls/year-month.html"),
			'year': require("gtsnaker~bootstrap-calendar@master/tmpls/year.html")
		},
		stop_cycling:       false
	};
